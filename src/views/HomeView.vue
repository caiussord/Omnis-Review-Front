                            ...
                            <div v-if="quickLoginOpen" class="quick-login__panel" @mouseenter="openQuickLogin"
                                ...
                                <form class="quick-login__form" @submit.prevent="submitQuickLogin">
                                    ...
                                    <div class="quick-login__password-field">
                                        <input v-model="quickLoginPassword"
                                            :type="quickLoginPasswordVisible ? 'text' : 'password'"
                                            class="quick-login__input" placeholder="Senha"
                                            autocomplete="current-password" />
                                        <button type="button" class="quick-login__password-toggle"
                                            @click="quickLoginPasswordVisible = !quickLoginPasswordVisible">
                                            <svg v-if="!quickLoginPasswordVisible" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
